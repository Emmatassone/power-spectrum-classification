...
for i in range(10,101,10):
    ...
    BH_powerspectra = preprocessor.collect_all_powerspectra(path_BH, bin_factor=i, BH=True)
    NS_powerspectra = preprocessor.collect_all_powerspectra(path_NS, bin_factor=i, BH=False)
